...
export class SignIn extends Component {
    ...
    login(e) {
        ...
        if (!this.state.email || !this.state.password) {
            ...
            axios.post(url, { email: this.state.email,password: this.state.password,}).then((response) => {
                if (response.data) {
    ...
    render() {
        ...
        <div>
            ...
            <Grid container item xs={12} sm={6} md={4} alignItems="center" direction="column" justify="space-between" style={{ padding: 10 }}>
            <div></div>
            ...
            <div style={{display: "flex",flexDirection: "column",maxWidth: 400, minWidth: 300,}}>
                ...
                <div style={{ height: 20 }} />
                <Button color="primary" variant="contained" onClick={(e) => this.login(e)}> Login </Button>
                <div style={{ height: 20 }} />
                <Button variant="outlined">
                    <Link to="/register" style={{ textDecoration: 'none',color:'black',width:'100%' }}> Don't have an Account? Sign Up
                    </Link>
                </Button>
            </div>
            <div />
